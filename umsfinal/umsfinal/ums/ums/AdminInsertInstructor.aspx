<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin-insert-instructor.aspx.cs" Inherits="UMS.admin_insert_instructor" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Admin Insert Instructor - Bugz University</title>
    <style>
        body {
    ...
    <form runat="server">
        <div class="sidebar">
            ...
            <nav>
                ...
                <a href="AdminCourseManagement">Course Management</a>
            ...
            <div class="form-container">
                ...
                <asp:Panel runat="server">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtInstructorId" runat="server" CssClass="form-control" required="required" />
                    </div>
                    <div class="form-group">
                    ...
                    <asp:Button ID="btnInsertInstructor" runat="server" Text="Insert Instructor" CssClass="btn" OnClick="btnInsertInstructor_Click" />
                </asp:Panel>
            </div>
        </div>
    </form>
