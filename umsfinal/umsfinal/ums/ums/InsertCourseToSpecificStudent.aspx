<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin-insert-course-to-student.aspx.cs" Inherits="UMS.admin_insert_course_to_student" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Assign Course to Student - Bugz University</title>
    <style>
        body {
            ...
            <div class="form-container">
                ...
                <asp:Panel runat="server">
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="rfvStudent" runat="server" ControlToValidate="ddlStudent" InitialValue="" ErrorMessage="Please select a student." ForeColor="Red" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="rfvEnrollmentDate" runat="server" ControlToValidate="txtEnrollmentDate" ErrorMessage="Please enter the enrollment date." ForeColor="Red" />
                    </div>
                    <asp:Button ID="btnAssignCourse" runat="server" Text="Assign Course" CssClass="btn" OnClick="btnAssignCourse_Click" />
                </asp:Panel>
            </div>
        </div>
    </form>
